<script>
	function Вывод_товаров_в_каталоге () {
		массив_лайков = '<?php
			foreach ($_SESSION['Лайки'] as $value) {
				echo $value;
			}
		?>';
			...
			if(r.readyState === 4 && r.status === 200) {
				...
				for ( i in q ) {
					...
					for (o in w) {
						...
						ячейка += `<li><a href="http://localhost/сайт для гималайской соли/?страница=О товаре&категория=${e[3]}&Название_товара=${e[0]}">${e[0]}</a>
								...
								<p style="float: left;">${e[1]} бел. руб.</p>
							`
